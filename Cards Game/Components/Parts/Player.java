...
public class Player {
    ...
    private ArrayList<Card> cards = new ArrayList<>();       // cards which players will be having in their hand.

    // Player constructor with passing as his id in parameter to create a player.
